...
- [x] **AUTH-01**: User can sign up and log in with phone number + OTP
- [x] **AUTH-02**: User can sign in with Google (one-tap)
- [x] **AUTH-03**: User can sign up and log in with email and password
